...
-   List each variable and the level of measurement. Note if there are
    ...
    -   height - ratio -no issues
    -   weight - ratio - no issues
    -   lvst 1 - ordinal - no issues
    -   lvst 2 - ordinal - no issues
    -   lvst 3- ordinal - no issues
    -   lvst 4 - ordinal - no issues
    -   frst 1 - ordinal- no issues
    -   frst 2 - ordinal - no issues
    -   frst 3 - ordinal - no issues
